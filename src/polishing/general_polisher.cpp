                                   ...
                                   std::chrono::duration<double>& polishAllBranchesDuration) const
{
    ...
    auto polishClosestBranchesStart = std::chrono::high_resolution_clock::now();
    ...
    auto polishClosestBranchesEnd = std::chrono::high_resolution_clock::now();
    polishClosestBranchesDuration += polishClosestBranchesEnd - polishClosestBranchesStart;


	//then, polish with all branches
    auto polishAllBranchesStart = std::chrono::high_resolution_clock::now();

    bubble.candidate = optimize(prePolished, bubble.branches,
								bubble.polishSteps);

    auto polishAllBranchesEnd = std::chrono::high_resolution_clock::now();
    polishAllBranchesDuration += polishAllBranchesEnd - polishAllBranchesStart;
}
